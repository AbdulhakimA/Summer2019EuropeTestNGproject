...
public class DDFLoginTest extends TestBase {
    ...
    public void loginTestDFF(String username,String password, String firstname,String lastname){
        extentLogger=report.createTest("Test "+firstname+" "+lastname);
        LoginPage loginPage =new LoginPage();
        loginPage.login(username,password);

        DeshBoardPage deshBoardPage =new DeshBoardPage();
        deshBoardPage.waitUntilLoaderScreenDisappear();

        String actualFullname=deshBoardPage.getUserName();
        String expectedFullname=firstname+" "+lastname;


        Assert.assertEquals(actualFullname,expectedFullname,"Compare fullname");
